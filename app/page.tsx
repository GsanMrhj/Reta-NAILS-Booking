  ...
  return (
    <main className="min-h-screen bg-pink-50 flex flex-col items-center justify-center p-6">
      <div className="bg-white p-10 rounded-3xl shadow-xl text-center max-w-lg w-full border-t-8 border-pink-400 hover:shadow-2xl transition-shadow duration-300">
        ...
        <button className="bg-pink-500 hover:bg-pink-600 text-white font-bold text-lg py-4 px-10 rounded-full transition-all duration-300 shadow-md hover:scale-105">
          احجزي موعدك الآن
        </button>
      </div>
    </main>
